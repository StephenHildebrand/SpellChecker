...
public class Dictionary {
    private int n = 0;                  /** number of dictionary entries in the table */
    private int capacity;               /** the number of buckets in the hash table */
    private int prime;                  /** prime factor */
    private long scale, shift;          /** shift and scaling factors */
    private LinkedList<Word>[] table;   /** Array of LinkedList word buckets */
    private int probeCount = 0;         /** total number of probes made during checking */
    private int lookupCount = 0;        /** count of lookup operations */
    ...
    public Dictionary(int capacity) { this(capacity, 109345121); }  // default prime
   ...
   public int hashCode(String word) {
     ...
     */
    public String remove(int key) { return bucketRemove(hashValue(key), key); }
    ...
    private static class Word implements Comparable<Word>{
        private int key;            /** the key to be stored */
